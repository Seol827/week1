...
// 생성자 함수
  ...
  componentDidMount(){    //첫번째만 실행되고 끝
    console.log('in componentDidMount!');
  }

  componentDidUpdate(prevProps, prevState){  //리렌더링이 끝난 다음 호출 실행
      console.log(prevProps, prevState);  //이전 부모가 준 것(여기서는 없음) / 이전 내 것
      console.log('in componentDidUpdate!');
  }

  componentWillUnmount(){ //컴포넌트가 사라질 때 호출
